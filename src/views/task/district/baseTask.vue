<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button type="primary" @click="openDialog">上传任务</el-button>
    </div>
...
<script>
  ...
  import { getBaseTask } from "@/api/task"
  ...
  export default {
    ...
    data() {
      return {
        ...
        UploadTaskParam:{
          visible:false,
          // url:"http://202.114.148.160/WHLDWebApi2/api/task/UploadBaseExcel"
          url:"http://223.255.43.21:82/WHLDWebApi2/api/task/UploadBaseExcel"
          // url:"http://localhost:42501/api/task/UploadBaseExcel"
        } 
      }
    },
    components:{
    ...
    methods:{
      getList(){
        ...
        getBaseTask(store.getters.district).then(res =>{         
